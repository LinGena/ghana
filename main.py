...
class Facebook():
    def __init__(self) -> None:
        ...
        self.queries = ['Emmanuel', 'Samuel', 'Isaac', 'Daniel', 'Michael', 'Nana', 'Joseph', 'Richard', 'Eric', 'Francis', 'John', 'George', 'David', 'Mohammed', 'Stephen', 'Prince', 'Charles', 'Kofi', 'Frank', 'Benjamin', 'Mary', 'Ebenezer', 'Kwame', 'James', 'Ernest', 'Esther', 'Peter', 'Patrick', 'Elizabeth', 'Paul', 'Gifty', 'William', 'Grace', 'Edward', 'Felix', 'Ibrahim', 'Abigail', 'Linda', 'Seth', 'Anthony', 'Abdul', 'Robert', 'Philip', 'Joyce', 'Patience', 'Bernard', 'Yaw', 'Kwabena', 'Albert', 'Alex', 'Rita', 'Kwaku', 'Henry', 'Gloria', 'Evelyn', 'Mavis', 'Frederick', 'Solomon', 'Victoria', 'Thomas', 'Mercy', 'Bright', 'Eunice', 'Beatrice', 'Evans', 'Priscilla', 'Janet', 'Cynthia', 'Sarah', 'Abdulai', 'Rebecca', 'Joshua', 'Faustina', 'Alfred', 'Kwasi', 'Vida', 'Comfort', 'Lydia', 'Doris', 'Victor', 'Maxwell', 'Mark', 'Florence', 'Enoch', 'Josephine', 'Kwadwo', 'Bismark', 'Gideon', 'Abraham', 'Kingsley', 'Moses', 'Diana', 'Jonathan', 'Justice', 'Sandra', 'Gabriel', 'Agnes', 'Patricia', 'Fred', 'Margaret', 'Nicholas', 'Martin', 'Dennis', 'Felicia', 'Jennifer', 'Christian', 'Adam', 'Lawrence', 'Gladys', 'Dorcas', 'Ruth', 'Bernice', 'Rose', 'Alhassan', 'Vivian', 'Godwin', 'Alexander', 'Kojo', 'Regina', 'Juliana', 'Andrew', 'Jacob', 'Stella', 'Augustine', 'Collins', 'Irene', 'Anita', 'Christiana', 'Hannah', 'Clement', 'Georgina', 'Cecilia', 'Theophilus', 'Kenneth', 'Ben', 'Theresa', 'Naomi', 'Simon', 'Raymond', 'Vincent', 'Richmond', 'Eugene', 'Dominic', 'Christopher', 'Osman', 'Benedicta', 'Matilda', 'Veronica', 'Ahmed', 'Francisca', 'Emelia', 'Martha', 'Jerry', 'Mabel', 'Edmund', 'Ernestina', 'Juliet', 'Prosper', 'Angela', 'Wisdom', 'Charity', 'Alice', 'Joe', 'Andrews', 'Sampson', 'Desmond', 'Ali', 'Sam', 'Monica', 'Elvis', 'Obed', 'Deborah', 'Augustina', 'Lucy', 'Belinda', 'Sylvia', 'Raphael', 'Chris', 'Haruna', 'Nancy', 'Edwin', 'Emma', 'Dorothy', 'Dora', 'Micheal', 'Yvonne', 'Rosemary', 'Nathaniel', 'Derrick', 'Iddrisu', 'Tony', 'Leticia', 'Joana', 'Judith', 'Barbara', 'Akwasi', 'Harriet', 'Kelvin', 'Steven', 'Mariam', 'Amos', 'Paulina', 'Gilbert', 'Catherine', 'Charlotte', 'Ellen', 'Julius', 'Sophia', 'Sylvester', 'Aaron', 'Kennedy', 'Zakaria', 'Doreen', 'Alberta', 'Louis', 'Matthew', 'Selina', 'Seidu', 'Olivia', 'Abubakar', 'Kate', 'Edith', 'Vera', 'Helena', 'Divine', 'Ivy', 'Franklin', 'Bridget', 'Issah', 'Eva', 'Mustapha', 'Amadu', 'Douglas', 'Jemima', 'Stanley', 'Pearl', 'Gertrude', 'Salifu', 'Jonas', 'Marian', 'Sheila', 'Johnson', 'Freda', 'Peace', 'Joel', 'Timothy', 'Harry', 'Betty', 'Henrietta', 'Anna', 'Sammy', 'Abubakari', 'Roland', 'Susana', 'Edna', 'Musah', 'Jude', 'Issaka', 'Hilda', 'Jane', 'Dan', 'Angelina', 'Constance', 'Arthur', 'Darko', 'Fatima', 'Reuben', 'Ruby', 'Mariama', 'Jeffrey', 'Jones', 'Festus', 'Fredrick', 'Bertha', 'Helen', 'Adelaide', 'Caroline', 'Pastor', 'Justina', 'Miriam', 'Reginald', 'Gordon', 'Williams', 'Ken', 'Leslie', 'Rhoda', 'Afia', 'Jessica', 'Amina', 'Baba', 'Eugenia', 'Papa', 'Leonard', 'Nelson', 'Shirley', 'Precious', 'Benedict', 'Umar', 'Erica', 'Hawa', 'Roger', 'Tina', 'Cyril', 'Oscar', 'Noah', 'Rachel', 'Adams', 'Atta', 'Sharon', 'Phyllis', 'Pamela', 'Karim', 'Jacqueline', 'Israel', 'Kevin', 'Edmond', 'Wilson', 'Theodora', 'Winifred', 'Rosina', 'Philomena', 'Genevieve', 'Wendy', 'Princess', 'Stephanie', 'Derek', 'Carl', 'Antoinette', 'Clifford', 'Christine', 'Clara', 'Larry', 'Gerald', 'Jeff', 'Amanda', 'Lily', 'Innocent', 'Dinah', 'Caleb', 'Thelma', 'Larbi', 'Eddie', 'Ethel', 'Rashida', 'Elsie', 'Harrison', 'Magdalene', 'Ezekiel', 'Louisa', 'Pius']
